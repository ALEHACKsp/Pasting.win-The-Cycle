...
std::string  DriverController::ReadString(unsigned long long Address, unsigned int Size)
{
	std::vector<char> buffer(Size, char{ 0 });

	this->ReadProcessMemory((unsigned long long)Address, (ULONGLONG*)&buffer[0], Size);
